# @emiplegiaqmnpm/tenetur-dolore-aperiam

![CI](https://github.com/emiplegiaqmnpm/tenetur-dolore-aperiam/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@emiplegiaqmnpm/tenetur-dolore-aperiam.svg?style=flat)](https://www.npmjs.com/package/@emiplegiaqmnpm/tenetur-dolore-aperiam)
...
```
npm i @emiplegiaqmnpm/tenetur-dolore-aperiam
```
...
const autoload = require('@emiplegiaqmnpm/tenetur-dolore-aperiam')
...
```js
import autoLoad from '@emiplegiaqmnpm/tenetur-dolore-aperiam'
...
- `opts.dependencies` - Set plugin dependencies to ensure correct load order
  ...
  Plugins and hooks are encapsulated together by folder and registered on the `fastify` instance which loaded the `@emiplegiaqmnpm/tenetur-dolore-aperiam` plugin. For more information on how encapsulation works in Fastify, see: https://fastify.dev/docs/latest/Reference/Encapsulation/#encapsulation
